...
<main>
    <div class="row">
        ...
        <div class="col-sm-8 ml-5" id="content">
            <div id="info" class="mt-5">
                <form class="form-horizontal" id="search">
                    <div class="form-group row pt-3 justify-content-center">
                        ...
                        <div class="input-error pt-1 pb-2 col-sm-7" id="casenum-input-error"
                             style="color:orangered;display:none;font:bold;">案号格式有误，请重新输入。
                        </div>
                    </div>
                </form>
                <section>
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group mr-5">
                            <label class="control-label ml-4">案件详情</label>
                            <textarea class="form-control ml-4" rows="6" style="overflow:scroll"
                ...
                <h5>信访风险预测</h5>
                <hr />
                <form class="form-horizontal" id="predict">
                    <div class="form-group row pt-3 justify-content-center">
                        <button class="btn btn-primary pl-5 pr-5" id="casenum-predict" type="submit">预测</button>
                    </div>
                    <div class="form-group row pt-2 pb-3">
